    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2 resposta">
                <h5 class="display-4 titulo">Selecione os parâmetros de consulta de ausentes</h5>
            </div>
...
if (isset($this->Dados['dadosAusente'])) {
  # code...
 ?>
 <br>
...
if ($this->Dados['tipoLista']==9) {
 ...
 ?> 
                <h2 class="display-4 titulo badge badge-default">Militares com Ausências no Serviço de Guarda
                </h2>
<?php 
}
elseif ($this->Dados['tipoLista']==1) {  ?>
<h2 class="display-4 titulo badge badge-default">Ausências no Serviço de <?php echo $this->Dados["tipoServ"]; ?> no mês de <?php echo $this->Dados["mesTexto"]; ?> de <?php echo $this->Dados["ano"]; ?>  

                </h2>
 <?php       # code...
    }
        elseif ($this->Dados['tipoLista']==2) { ?>
            <h2 class="display-4 titulo badge badge-default">Ausências no Serviço de <?php echo $this->Dados["tipoServ"]; ?> no período de <?php echo $this->Dados["dataInicial"]; ?> à <?php echo $this->Dados["dataFinal"]; 
            ?>
                </h2>
                <?php
    } elseif ($this->Dados['tipoLista']==3) { ?>

     <h2 class="display-4 titulo badge badge-default">Ausências no período de <?php echo $this->Dados["dataInicial"]; ?> à <?php echo $this->Dados["dataFinal"]; ?> 
                </h2>
                <?php   
}
...
elseif ($this->Dados['tipoLista']==4) { ?>
     ...
     <h2 class="display-4 titulo badge badge-default"> Ausências de militares da(o) <?php echo $this->Dados['desigUeo']; ?> nos diferentes serviços
                </h2>
                <?php   
}
elseif ($this->Dados['tipoLista']==5) { ?>

     <h2 class="display-4 titulo badge badge-default">Ausências de militares da(o) <?php echo $this->Dados['desigUeo']; ?> no período de <?php echo $this->Dados["dataInicial"]; ?> à <?php echo $this->Dados["dataFinal"]; ?>
                </h2>
                <?php   
}
...
?>
    ...
    if (!empty($this->Dados['dadosAusente'])):
        ?>
...
$res = new \App\adms\Models\admsEscalaServico();
                foreach ($this->Dados['dadosAusente'] as $escala) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $descricao_motivo; ?></td>
