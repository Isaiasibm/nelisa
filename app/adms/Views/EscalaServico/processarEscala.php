    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2 resposta">
                <h2 class="display-4 titulo">Processar Escala de Serviço</h2>
            </div>
...
//echo $meses[date('m')];
   ...
   <?php 
if(count($this->Dados["MilitaresEscalados"])>0){
...
<div class="mr-auto p-2">
                <h2 class="display-4 titulo badge badge-default">Escala para o serviço de <?php echo $this->Dados['tipoServ']; ?> no mês de <?php echo $this->Dados['mesTexto']; ?> do ano de <?php echo $this->Dados['ano']; ?> </h2>
            </div>
...
<div class="table-responsive">
        <table class="table table-striped table-hover table-bordered tabelaPersonalizadaDataTable">
            ...
            <thead align="center">
                <tr>
                    ...
                    <th>Patente</th>
                    <th>Nome Completo</th>                    
                    <th class="hidden-xs">Data de Serviço</th>
                    <th class="hidden-xs">U/E/O</th>
                    <th class="hidden-xs">Data Último Serviço</th>
                    <th>Ações</th>
                </tr>
            </thead><tbody>
 ...
 <?php
  ...
  $cont=0;
      foreach ($this->Dados["MilitaresEscalados"] as $MilitaresEscalados) {
      $cont++;

 extract($MilitaresEscalados);
 $listarDados=$dadosEscalads->lisEscalaProcessadaAgora($NIP);
 foreach ($listarDados as $lis) {
     extract($lis);

      $idNip=$id."-".$NIP;
      $Ultimo_serv='';
      if ($data_ultimo_servico=='') {
        $Ultimo_serv='Novo';
      }
      else{
        $Ultimo_serv=$data_ultimo_servico;
      }
                          ...
                          <td class="text-center">
                            <div class="dropdown show">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="<?php echo URLADM.'controleEscalaServico/visualizar/'.$idNip; ?>">Histórico</a>
