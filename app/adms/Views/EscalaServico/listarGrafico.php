    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2 resposta">
                <h5 class="display-4 titulo">Gráficos das Ausências</h5>
            </div>
...
if (isset($this->Dados['ausenteUnidadeGrafico'])) {
    // code...

$total = 0;
foreach($this->Dados['ausenteUnidadeGrafico'] as $dado){
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Gráfico de Ausências por Unidades no mês de <?php echo $this->Dados["mesTexto"] ?> de <?php echo $this->Dados["ano"] ?>'
    },
    accessibility: {
        announceNewData: {
            enabled: true
    ...
    yAxis: {
        title: {
            text: 'Total Percentual de ausências por unidade'
        }
...
if (isset($this->Dados['ausenteUnidadeGraficoIntervalo'])) {
    // code...

$total = 0;
foreach($this->Dados['ausenteUnidadeGraficoIntervalo'] as $dado){
    $total = $total + $dado['quantidade'];
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Gráfico de Ausências por Unidades no período de <?php echo $this->Dados["dataInicial"] ?> à <?php echo $this->Dados["dataFinal"] ?>'
    },
    accessibility: {
        announceNewData: {
            enabled: true
...
if (isset($this->Dados['ausenteTipoServicoGrafico'])) {
    // code...

$total = 0;
foreach($this->Dados['ausenteTipoServicoGrafico'] as $dado){
    $total = $total + $dado['quantidade'];
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Gráfico de Ausências por Tipo de serviço no mês de <?php echo $this->Dados["mesTexto"] ?> de <?php echo $this->Dados["ano"] ?>'
    },
    accessibility: {
        announceNewData: {
            enabled: true
    ...
    yAxis: {
        title: {
            text: 'Percentual de ausências por tipo de serviço'
        }
...
if (isset($this->Dados['ausenteTipoServicoGraficoIntervalo'])) {
    // code...

$total = 0;
foreach($this->Dados['ausenteTipoServicoGraficoIntervalo'] as $dado){
    $total = $total + $dado['quantidade'];
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Gráfico de Ausências por Tipo de serviço no período de <?php echo $this->Dados["dataInicial"] ?> à <?php echo $this->Dados["dataFinal"] ?>'
    },
    accessibility: {
        announceNewData: {
            enabled: true
